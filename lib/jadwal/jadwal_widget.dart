                    ...
                    children: [
                      Padding(
                        ...
                        child: StreamBuilder<List<JadwalRecord>>(
                          stream: queryJadwalRecord(
                            queryBuilder: (jadwalRecord) =>
                                jadwalRecord.where('hari', isEqualTo: 'Monday'),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                    ...
                    child: StreamBuilder<List<JadwalRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          children:
                              List.generate(jadwalSelasaJadwalRecordList.length,
                                  (jadwalSelasaIndex) {
                            final jadwalSelasaJadwalRecord =
                                jadwalSelasaJadwalRecordList[jadwalSelasaIndex];
                            return Padding(
                              padding:
            ...
            Padding(
              ...
              child: StreamBuilder<List<JadwalRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    mainAxisSize: MainAxisSize.max,
                    children: List.generate(jadwalRabuJadwalRecordList.length,
                        (jadwalRabuIndex) {
